module.exports = async () => {
    ...
    if (event) {
        ...
        console.log(`Submitter:\t ${event.args._tokenAddress}`);
        console.log(`Submitter:\t ${event.args._validatorAddress}`);
        console.log(`Submitter:\t ${event.args._symbol}`);
        console.log(`Submitter:\t ${event.args._amount}`);
        console.log("-------------------------------------------");
    } else {
